        ...
        children: [
          ...
          Column(
            ...
            children: [
              SizedBox(
                key: _headerKey,
                height: MediaQuery.of(context).padding.top + 70 + (screenWidth * 0.04), // Match LiquidMeltingHeader height + top padding
              ),
          ...
          // Melting glass header - matches LiquidMeltingHeader exactly
          Positioned(
            top: 0,
            left: 0,
            right: 0,
            child: SizedBox(
              height: MediaQuery.of(context).padding.top + 70, // Match LiquidMeltingHeader maxExtent
              child: ShaderMask(
                shaderCallback: (rect) {
          ...
          // Header title - matches LiquidMeltingHeader exactly
          Positioned(
            top: MediaQuery.of(context).padding.top + 4,
            left: 24, // Same as LiquidMeltingHeader
            right: 24,
            child: Text(
              'Bulletin',
              style: GoogleFonts.inter(
                fontSize: 36, // Same as LiquidMeltingHeader
